    ...
    play(){
        ...
        if(this.storylineBool){
            ...
            if(this.touchGround != true){
             ...
             if(this.player.plr.x > displayWidth * 2.79){
                 this.cameraPlus = 0
             }

             function touchStarted(){
                 if(mouseX < this.leftMove.x - this.leftMove.width / 2 && mouseX > this.leftMove.x + this.leftMove.width / 2 && mouseY < this.leftMove.y - this.leftMove.height / 2 && mouseY > this.leftMove.y + this.leftMove.height / 2){
                    this.player.plr.x -= 4
                    this.player.plr.changeAnimation("run", panimation)
                    this.player.plr.mirrorX(-1)
                 }
